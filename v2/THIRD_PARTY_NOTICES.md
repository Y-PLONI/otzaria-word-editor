...
> Icons. שני היוצאים הם סמלי מיתוג, ושניהם נשארים ציור בבית מאותה סיבה —
> ה־MIT של Microsoft מכסה אייקוני ממשק ולא סמלי מוצר:
>
> - `word` — תג האפליקציה בשורת הכותרת וב„אודות”. ממולא ולא קווי, כמקובל בתגי
>   אפליקציה (כך גם ב־Word עצמו), והוא אינו יושב בשורה אחת עם אייקוני פקודה.
